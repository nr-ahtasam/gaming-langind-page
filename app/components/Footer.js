      ...
      <footer className="">
        <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <h2 className="mt-4 max-w-xs text-3xl">
                Get updates on your favourite games
              </h2>

              <div>
                <p className="text-xl font-bold">Ready to explore?</p>
                <button className="bg-[#070B1D] mt-10 px-6 py-3 rounded-3xl border border-gray-100">Get Started
                </button>
              </div>
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
              <div>
                <p className="font-medium text-[#BDC3FF]">Services</p>
